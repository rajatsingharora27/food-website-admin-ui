...
const Login = () => {
  ...
  return (
    <div className="flex flex-wrap w-full items-center justify-center ">
      <div className="hidden bg-slate-100 w-1/2 shadow-2xl h-screen  md:flex md:flex-col md:items-center md:justify-center ">
        <img
          className="hidden  object-contain md:h-10  lg:h-24 xl:h-40 md:block lg:w-[500px]"
          src="http://res.cloudinary.com/dlg7e8dwa/image/upload/eiEPb"
          alt="Brand Logo"
        />
      </div>
